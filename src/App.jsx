          ...
          <div className="w-full flex flex-col items-center gap-3">
            ...
            <button
              onClick={() => {
                ...
                >
                  <img src="/icons/spotify-tile.svg" alt="Spotify" className="w-full h-full object-cover block" />
            ...
            <button
              ...
              style={{ overflow: 'hidden' }}
            >
                  <img src="/icons/soundcloud-tile.svg" alt="SoundCloud" className="w-full h-full object-cover block" />
              <span style={{ position: 'absolute', right: 6, bottom: 6 }}>
                {soundcloudConnected ? (
                  // filled green dot when connected
                  <div className="w-3.5 h-3.5 rounded-full" style={{ background: '#43b581', border: '1px solid rgba(0,0,0,0.6)' }} />
